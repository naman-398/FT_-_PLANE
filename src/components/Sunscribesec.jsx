    ...
    return (
        ...
        <div className=' bg-[#F5F5FF] md:pt-[80px] xs:pt-[60px] pt-[40px] lg:pt-[100px] xs:pb-[60px] pb-[40px] lg:pb-[70px] overflow-hidden' id='your'>
            <div className=' max-w-1200px px-3 mx-auto flex justify-center items-center flex-col'>
                ...
                <button className=' btn duration-300 border-[2px] border-[transparent] hover:border-[#313EF7] hover:bg-transparent hover:text-[#313EF7] font-ff-mont text-[16px] font-semibold text-[#FFF] leading-[28px] p-[10px_25px] bg-[#313EF7] rounded-[56px]  xs:hidden xs:mt-4 mt-2'>Subscribe</button>
            </div>
        </div>
    )
}
